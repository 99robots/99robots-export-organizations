...
<div class="nnr-header">
	...
	<div class="nnr-product-details">
		<span class="nnr-product-name"><?php _e('Export Organizations', self::$text_domain); ?></span>
		<span class="nnr-product-version"><?php echo NNROBOTS_EXPORT_ORGANIZATIONS_VERSION_NUM; ?></span>
	</div>
